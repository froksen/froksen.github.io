# Fremskridt: Tilføjelse af ressourcer til delemner

Dette dokument holder styr på hvilke delemner der mangler digitale ressourcer
(simulering, video, DR-dokumentar) i `index.html`.

## Status

### Tema 1: Bæredygtig energiforsyning — ✅ FÆRDIG (alle 13 delemner har ressourcer)

### Tema 2: Bæredygtig produktion
- [x] Plastikforurening og genanvendelse
- [x] Tøjproduktion og miljøpåvirkning
- [x] Økologisk overfor konventionelt landbrug
- [x] Madspild i husholdninger
- [x] Produktion af elektronik
- [x] Emballage og bæredygtighed
- [x] Produktion af bioplast
- [x] Vandforbrug i industriproduktion
- [x] Bæredygtig skovbrug
- [x] Produktion af kød vs. plantebaseret mad
- [x] Genbrug af metaller
- [x] Produktion af cement og CO₂-udledning
- [x] Produktionsaffald og miljøpåvirkning
